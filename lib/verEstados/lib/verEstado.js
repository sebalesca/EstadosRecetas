...
function verEstadoReceta(idReceta, callback) {
    ...
    recetaModelo.verEstadoAcesUnaReceta(idReceta, function(err, recetaAces) {
        if (err) {
            ...
            detalle.cant_obs = 'Cantidad de observaciones: ' + cant_obs;
            detalle.cant_notas = 'Cantidad de notas: ' + cant_notas;
            detalle.RP1 = 'Rp1: ' + productos.RP1;
            detalle.cantidad1 = 'Cantidad de rp1: ' + productos.cantidad1;
            detalle.RP2 = 'Rp2: ' + productos.RP2;
            detalle.cantidad2 = 'Cantidad de rp2: ' + productos.cantidad2;
            detalle.fechaCamoyte = 'FechaCamoyte: ' + fechaCamoyte;
            detalle.comunicacionDrog = 'Fecha Com drogueria: ' + feComunicaconDrog;
            detalle.remito = 'Remito: ' + remito;
            detalle.feremito = 'Fecha Remito: ' + feremito;
            detalle.codAp = 'Codap: ' + codap;
            detalle.idDrogueria = 'iddrogueria asignada: ' + iddrogueria;
            detalle.observaciones = 'Observaciones: ' + s_Obs;
            detalle.notas = 'Notas: ' + s_notas;
