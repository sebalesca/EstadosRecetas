...
recetaModelo.verEstadoAces = function(DatosRecetas, callback) {
    ...
    var soap = require('soap');
    //console.dir('esta es la receta de verEstadoAces',);
    ...
    /*if (!DatosRecetas) {
        var error = {};
        error = {
            descripcion: 'Receta inexistente'
        };
        ...
        if (!err) {
            ...
            client.ObtenerEstadoTramite(receta, function(err, result) {
                ...
                if (!err) {
                    ...
                    //callback(null, result.ObtenerEstadoTramiteResult.diffgram.NewDataSet);
                    fs.appendFile('./logs/log.txt', result + ' \r', function(err) {
                        if (err) {
                            console.log(err);
                        } else {
                            console.log('Se ha escrito correctamente el log'.info);
                    ...
                    //console.dir(result.ObtenerEstadoTramiteResult.diffgram.NewDataSet);
                    callback(null, result.ObtenerEstadoTramiteResult.diffgram.NewDataSet);
